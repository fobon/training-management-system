...
<body>
    ...
    <div class="container mt-2">
        ...
        <form action="{{ route('manualbooks.update', $manualbook->id)  }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="code" class="form-label">Manualbook Date</label>
                <input type="date" name="date" class="form-control" id="date" aria-describedby="date" placeholder="Date">
              </div>

            <div class="mb-3">
                <label for="address" class="form-label">Manualbook Description</label>
                <input type="text" name="description" class="form-control" id="description" aria-describedby="description" placeholder="Description">
